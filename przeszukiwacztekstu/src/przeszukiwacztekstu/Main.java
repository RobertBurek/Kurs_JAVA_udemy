...
public class Main extends JFrame
{
    ...
    public void initComponents()
    {
        ...
        obszarTekstowy.select(obszarTekstowy.getText().indexOf("tttt"), obszarTekstowy.getText().indexOf("tttt")+"tttt".length());
